...
import { categoryLabel, decisionLabel, documentReviewScopeCopy, documentVersionLabel, emptyActiveDocumentReviewCopy, findingMatchesFilter, handlingLabel, plainAnalysisStatus, progressPresentation, reviewCounts, reviewSectionVisibility, reviewStages, snapshotPresentation, versionDetailsButtonLabel, versionDetailsInitiallyExpanded, versionSummary, type SmartReviewFilter } from "@/lib/document-review-presentation";
