...
Current update (2026-09-19): M3-01 through M3-10 and Milestone 3 are COMPLETE and manually validated. M4-01 through M4-04 are COMPLETE / MANUALLY VALIDATED; Milestone 4 is IN PROGRESS and M4-05 is NEXT / NOT STARTED. The consolidated M4-02/M4-03/M4-04 checkpoint explicitly assembles a finalized Selected-for-Proposal M3 review into one exact Draft EstimateVersion, preserving contractor Base Bid separately from BB Builders leveling adjustments and their exact source records. Backend Decimal arithmetic has a fixed order and `ROUND_HALF_UP` two-decimal adjustment rounding; allowances, alternate inclusion, exclusions, markup/overhead/profit/contingency/tax are always explicit, missing values remain null, and mixed currencies block totals. Draft commercial records are operator-editable in place with audit/recalculation; Viewer is read-only. Project 3 Estimate V2 manually validated CAD 176,500 Base Bid + CAD 3,000 M3 leveling + CAD 5,000 included allowance + CAD 4,500 included alternate + CAD 1,000 fixed adjustment = CAD 190,000 pre-tax, plus explicit 5% tax = CAD 199,500 internal calculated estimate. Estimate V1 and exact Proposal V1/V2 bindings remained historical, and M3 stayed unchanged. No PDF, client finalization, award, subcontract, purchase order, M4-05 behavior, or provider call is included. Check Git and `docs/CURRENT_STATUS.md` for authoritative state; older checkpoints below are historical.
