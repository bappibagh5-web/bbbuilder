...
Current update (2026-09-19): M3-01 through M3-10 and Milestone 3 are COMPLETE and manually validated. M4-01 through M4-07 are COMPLETE / MANUALLY VALIDATED; M4-08 is NEXT / NOT STARTED and Milestone 4 remains IN PROGRESS. Project 3 Proposal V2 is Finalized and its exact Estimate V2 is Frozen with immutable client/project/financial snapshots and fingerprints at CAD 190,000 pre-tax, CAD 9,500 tax and CAD 199,500 total. Proposal V1 and Estimate V1 remain historical. Client preview/PDF excludes internal contractor Base Bid, M3 leveling, adjustment rates and procurement rationale. Private PDF artifacts are append-only and template-versioned: the defective V1 FileAsset is preserved and corrected template V2 is a separate immutable artifact using portable punctuation and formatted money. Future corrections require successor Estimate/Proposal versions. Finalization is not acceptance or award, and no external provider creates PDFs. Check Git and `docs/CURRENT_STATUS.md` for authoritative state; older checkpoints below are historical.
